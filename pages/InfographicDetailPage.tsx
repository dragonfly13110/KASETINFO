  ...
  useEffect(() => {
    if (id) {
      const loadInfographicDetail = async () => {
        setIsLoading(true);
        try {
          // The 'id' from route params is expected to be the contentPath (e.g., "infographics/filename.json")
          // This needs to be handled carefully if your IDs are different from file paths.
